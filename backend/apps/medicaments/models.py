...
class Medicament(models.Model):
    ...
    Attributs:
        ...
        categorie (FK): Catégorie de classification.
        forme (str): Forme galénique (comprimé, sirop, etc.).
        ...
        ordonnance_requise (bool): Si le médicament nécessite une prescription.
        est_actif (bool): Soft delete flag.
    """
